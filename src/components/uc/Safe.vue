                                ...
                                <div class="detail-list" style="width: 100%;">
                                    <Form ref="formValidate6" :model="formValidate6" :rules="ruleValidate" :label-width="85" style="text-align:center;">
                                        ...
                                        <FormItem :label="$t('uc.safe.country')" prop="country">
                                            <Select v-model="formValidate6.country" placeholder="请选择">
                                                <Option v-for="item in countryList" :value="item.zhName" :key="item.value">{{ item.zhName }}</Option>
                                            </Select>
                                        </FormItem>
                                        <!-- 真实姓名 -->
                                        ...
                                        <div style="height:550px;">
                                            ...
                                            <tr style="height: 250px">
                                                ...
                                                <div class="photo-require">
                                                    ...
                                                    <p>{{$t('uc.safe.required1_1')}}</p>
                                                    <p>{{$t('uc.safe.required1_2')}}</p>
                                                    <p>{{$t('uc.safe.required1_3')}}</p>
                                                    <p>{{$t('uc.safe.required1_4')}}</p>
                                                </div>
                                            </tr>
                                            <tr style="height: 250px">
                                                ...
                                                <div class="photo-req">
                                                    ...
                                                    <p>{{$t('uc.safe.required2_6')}}</p>
                                                    <p>{{$t('uc.safe.required2_7')}}</p>
                                                </div>
                                            </tr>
                                        </div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      memberlevel:"",
      frontCardImg: require("../../assets/images/frontCardImg1.png"),
      backCardImg: require("../../assets/images/backCardImg1.png"),
      ...
      ruleValidate: {
        ...
        vailCode5: [
          ...
          country: [
              {
                  required: true,
                  message: this.$t("uc.safe.countrytip"),
                  trigger: "blur"
              }
          ],
        realName: [
  ...
  methods: {
    ...
    submit(name) {
      ...
      if (name == "formValidate6") {
        ...
        let param = {};
        param["country"] = this.formValidate6.country;
