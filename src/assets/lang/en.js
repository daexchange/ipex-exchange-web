module.exports = {
    ...
    exchange: {
        ...
        balance: 'balances',
        qingxian: 'Please',
        shimingrenzheng: 'Carry Out Authentication',
        or: 'or',
    ...
    otc: {
        ...
        fabijiaoyi: 'Fiat Deal',
        kuaisumaimai: 'Convenient, secure, and fast trading of digital currencies',
        chengweishangjia: 'Become Business',
        scykj: 'Fixed Market Price',
        shishibodong: 'Real-time fluctuations based on market prices',
        freeoffee: 'Completely free of charge',
        suojianjisuode: 'User WYSIWYG, trading price, no platform fee',
        jishichengjiao: 'Instant clinch a deal',
        zhinengpipei: 'Introducing platform service merchants, intelligent matching, and closing orders without waiting for a match',
        pingtaidanbao: 'Platform guarantees',
        pingtairenzheng: 'Platform certified merchants, safe and secure, 24-hour customer service escorts for transactions',
        myad: {
            title: 'My Ad',
            post: 'Post An Ad',
        ...
        checkuser: {
            ...
            idcarddone: 'Passport certified',
            idcardundo: 'Passport unauthorized',
            language: 'language',
    ...
    usercenter: {
        zhanghuguanli: 'Account Manage',
        zichanguanli: 'Asset Manage',
        exchangeaccount: 'Exchange Account',
        legalcurrencyaccount: 'OTC Account',
        bibiguanli: 'Exchange Manage',
        fabiguanli: 'OTC Manage',
    },
    uc: {
        login: {
        ...
        finance: {
            ...
            money: {
                ...
                transfertip1: 'Transfer Quantity',
        ...
        safe: {
            ...
            required: 'Required:',
            required1_1: 'The passport must contain your full legal name, photo, date of birth, nationality and expiration date;',
            required1_2: 'The passport must be valid: Please double check the expiration date;',
            required1_3: 'The passport must have a high resolution;',
            ...
            required2_6: 'The signature must be same as the name shown on your passport;',
            required2_7: 'The image must be JPG/JPEG/PNG format, and no larger than 2M.',
            save: 'Save',
            reset: 'Reset',
            email: 'Email',
            ...
            countrytip: 'Please enter your nationality',
        ...
        identity: {
            ...
            become: "Become IPEX Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        bangzhuzhongxin: 'Support Center',
        gengduo: 'more',
    ...
    description: {
        ...
        // message3: 'IPEX Exchange supports 10,00 transactions per second, giving users a hearty transaction experience',
        message4: 'Multi-terminal APP, easily traded between',
        message5: 'IPEX international digital encryption asset trading platform mobile client, focusing on palm trading experience',
    },
    footer: {
    ...
    index: {
        ...
        BHBregister: "IPEX account registration",
        ...
        fenpeijizhi: 'A description of the IPEX income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, IPEX will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
