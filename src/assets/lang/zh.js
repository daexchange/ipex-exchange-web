module.exports = {
    ...
    otc: {
        ...
        transaction: '买卖交易',
        fabijiaoyi: '法币交易',
        kuaisumaimai: '便捷、安全、快速买卖数字货币',
        chengweishangjia: '成为商家',
        scykj: '市场一口价',
        shishibodong: '根据市场价格实时波动',
        freeoffee: '完全免手续费',
        suojianjisuode: '用户所见即所得，买卖价格外，无需任何平台手续费',
        jishichengjiao: '即时成交',
        zhinengpipei: '引入平台服务商家，智能匹配，成交订单，无须等待撮合',
        pingtaidanbao: '平台担保',
        pingtairenzheng: '平台认证商家，安全有保障，24小时客服为交易保驾护航',
        myad: {
            title: '我的广告',
            post: '发布广告',
    ...
    uc: {
        ...
        finance: {
            ...
            money: {
				...
				transfertip3: '从',
				transfertip4: '划转到',
				transfertip5: '划转到法币账户',
				transfertip6: '划转到币币账户',
				transfersuccess: '划转成功!',
				transfererr1: '请输入有效的数量!',
                transfererr2: '超出最大可划转数量!',
            },
            record: {
                start_end: '起止时间',
                to: '至',
        ...
        safe: {
            ...
            idcard: '护照号码',
            upload: '点击上传',
            upload_positive: '上传护照个人资料页',
            upload_negative: '上传手持证件照',
            upload_hand: '上传手持护照',
            required: '必填：',
            required1_1: '护照必须包含您的完整法定姓名、照片、出生日期、国籍和有效期；',
            required1_2: '护照需在有效期内，请查看护照有效期；',
            required1_3: '护照必须具有足够分辨率；',
            required1_4: '图像必须为JPG / JPEG / PNG格式，且不得大于2M。',
            required2_1: '请提供您持有护照的照片。在同一张照片中展示IPEX和显示的申请日期 - 带有“IPEX”字样的注释，',
            required2_2: '申请日期和您的签名。确保您的面部清晰可见，并且所有身份证件细节都清晰可读；',
            required2_1_2: '请提供您持有护照的照片。在同一张照片中展示IPEX和显示的申请日期 - 带有“IPEX”字样的注释，申请日期和您的签名。确保您的面部清晰可见，并且所有身份证件细节都清晰可读；',
            required2_3: '面部清晰可见；',
            required2_4: '护照清晰可读；',
    ...
    description: {
        ...
        // message3: 'IPEX数字资产交易平台支持每秒1000笔交易，给用户带来酣畅淋漓\n的交易体验',
        title1: '安全',
        title2: '快捷',
        title3: '体验',
        ...
        message5: '星际数字加密资产交易平台手机客户端，专注掌上交易体验',
    },
    footer: {
        wechatkefu: "微信客服",
        notice: '平台公告',
    ...
    index: {
        ...
        BHBregister: "IPEX账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于IPEX收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，IPEX会拿出平台的80% (扣除税费后) 的收入分配给IPEX持有者，20%的收入用来支持平台的研发及运营。",
